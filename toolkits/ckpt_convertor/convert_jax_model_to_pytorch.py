...
# Import RLinf's config for custom configs like pi05_behavior
from rlinf.models.embodiment.openpi.dataconfig import get_openpi_config as get_rlinf_config
...
def main(
    ...
    *,
    ...
    """
    # Try RLinf's config first (for custom configs like pi05_behavior),
    # fall back to openpi's config if not found
    try:
        model_config = get_rlinf_config(config_name).model
    except ValueError:

...
class LeRobotBehaviorDataConfig(DataConfigFactory):
    ...
    def create(
        ...
        # Aligned with openpi-comet B1kInputs format: separate keys for each camera.
        ...
        data_transforms = _transforms.Group(
            inputs=[behavior_policy.BehaviorInputs(action_dim=model_config.action_dim, model_type=model_config.model_type)],
            outputs=[behavior_policy.BehaviorOutputs(action_dim=23)],
        )
